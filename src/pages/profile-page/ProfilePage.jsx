    ...
    <div>
      <div className="max-w-[45rem] rounded w-full p-4 bg-white border">
        <div className="relative flex justify-center">
          <img src={user.backgroundImage} className="w-full h-[12rem]" />
        ...
        <div className="flex flex-col text-lg items-center mt-6">
          <p className="mt-2 font-bold text-2xl">{`${user.firstName} ${user.lastName}`}</p>
          <p className="text-slate-600">@vishalg8454</p>
